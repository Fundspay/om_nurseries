...
import { adminStatisticsData } from '@/utils/fackData/adminStatisticsData'
...
const AdminOverviewStatistics = () => {
    return (
        <>
            {
                adminStatisticsData.map(({ id, completed_number, progress, progress_info, title, total_number, icon }) => (
...
export default AdminOverviewStatistics
