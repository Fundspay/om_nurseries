...
import { managerStatisticsData } from '@/utils/fackData/managerStatisticsData'
import getIcon from '@/utils/getIcon'


const ManagerOverviewStatistics = () => {
    return (
        <>
            {
                managerStatisticsData.map(({ id, completed_number, progress, progress_info, title, total_number, icon }) => (
...
export default ManagerOverviewStatistics
