...
import { gardnerStatisticsData } from '@/utils/fackData/gardnerStatisticsData'
import getIcon from '@/utils/getIcon'


const GardnerOverviewStatistics = () => {
    return (
        <>
            {
                gardnerStatisticsData.map(({ id, completed_number, progress, progress_info, title, total_number, icon }, index) => (
...
export default GardnerOverviewStatistics
