...
const overviewInfo = [
    { title: "Watering Tasks", icon: "feather-droplet", total_number: "45", completed_number: "30", progress: "28", chartColor: "#3454d1", color: "primary" },
    { title: "Fertilizer Tasks", icon: "feather-star", total_number: "30", completed_number: "18", progress: "15", chartColor: "#ffa21d", color: "warning" },
    { title: "Plant Health Alerts", icon: "feather-alert-triangle", total_number: "12", completed_number: "5", progress: "34", chartColor: "#d13b4c", color: "danger" },
    { title: "Ready for Dispatch", icon: "feather-truck", total_number: "250", completed_number: "220", progress: "42", chartColor: "#25b865", color: "success" },
]
