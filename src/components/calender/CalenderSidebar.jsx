      ...
      <PerfectScrollbar>
        ...
        <div className="content-sidebar-body">
          <div id="lnb-calendars" className="lnb-calendars">
            ...
            <h2 className="px-4 fs-10 fw-bold text-uppercase my-4 text-muted text-spacing-1 text-truncate-1-line">Tasks &amp; Schedules</h2>
          </div>
          {
                ...
                <div className="d-flex align-items-start">
                  ...
                  <div className="ms-3 schedule-body">
                    <div className="text-dark">
                      ...
                      {/* <p className="fs-12 fw-normal text-muted my-3 text-truncate-2-line"></p> */}
                    </div>
