...
const LoginForm = ({ registerPath, resetPath }) => {
    ...
    return (
        <>
            ...
            <p className="fs-12 fw-medium text-muted">Thank you for getting back <strong>to Om Nurseries.</strong></p>
            <form onSubmit={handleLogin} className="w-100 mt-4 pt-2">
                <div className="mb-4">
                    <input type="email" className="form-control" placeholder="Email or Username" defaultValue="omnurseries@gmail.com" required />
                </div>
                <div className="mb-3">
