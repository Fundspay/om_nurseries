                        ...
                        <table className="table mb-0">
                            <thead>
                                <tr className="border-b">
                                    <th scope="row">{title === "Recent Plant Activity" ? "Time" : "Time"}</th>
                                    <th>{title === "Recent Plant Activity" ? "Activity" : "Activity"}</th>
                                    <th>Block</th>
                                    <th>{title === "Recent Plant Activity" ? "Staff" : "Staff"}</th>
                                                ...
                                                <div className="d-flex align-items-center gap-3">
                                                    {
                                                        user_img ?
                                                            ...
                                                            <div className="text-white avatar-text user-avatar-text">{
                                                                user_name.split(" ").length > 1 ? user_name.split(" ")[0][0] + user_name.split(" ")[1][0] : user_name.split(" ")[0][0]
                                                            }</div>
                                                    }
                                                    <a href="#">
