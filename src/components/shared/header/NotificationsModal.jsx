...
const Card = ({ src, time, titleFirst, titleSecond }) => {
    return (
        <div className="notifications-item">
            {src ? <img src={src} alt="" className="rounded me-3 border" /> : <div className="avatar-text user-avatar-text text-white rounded me-3 border">{titleFirst.split(" ").length > 1 ? titleFirst.split(" ")[0][0] + titleFirst.split(" ")[1][0] : titleFirst.split(" ")[0][0]}</div>}
