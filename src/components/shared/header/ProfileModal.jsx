...
const ProfileModal = () => {
    return (
        <div className="dropdown nxl-h-item">
            <a href="#" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside" style={{ display: 'flex', alignItems: 'center' }}>
                <div className="avatar-text user-avatar-text text-white me-0" style={{ width: '35px', height: '35px' }}>AD</div>
            </a>
            <div className="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                <div className="dropdown-header">
                    <div className="d-flex align-items-center">
                        <div className="avatar-text user-avatar-text text-white user-avtar">AD</div>
                        <div>
